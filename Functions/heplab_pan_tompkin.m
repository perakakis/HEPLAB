% heplab_pan_tompkin - Pan-Tompking peak detection, called by heplab.m
%
% Modified version of the function BioSigKit.PanTompkins(),distributed with
...
function [qrs_amp_raw,qrs_i_raw]=heplab_pan_tompkin(ecg,fs,gr)
...
%% Initialize
h = waitbar(0,'R wave detection in progress... Please wait...');
